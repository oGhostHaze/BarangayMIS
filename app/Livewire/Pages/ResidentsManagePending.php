...
class ResidentsManagePending extends Component
{
    use WithPagination;
    use Toastr;
    ...
    public function render()
    {
        ...
        $residents = $residents->doesntHave('user')->paginate($this->perPage);
        return view('livewire.pages.residents-manage-pending', compact('residents'));
    }
