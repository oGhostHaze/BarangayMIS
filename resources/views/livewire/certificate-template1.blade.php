            ...
            @switch($request->certificate_type)
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-4 row">
                            ...
                            <div class="col-8 text-start">
                                <p class="mt-3 fs-3 fw-bold">TO WHOM IT MAY CONCERN:</p>

                                <p class="mt-4 fs-3 lh-base">
                                    ...
                                    @if ($request->certificate_type == 'First Time Jobseeker Certificate')
                                        , is a qualified availee of <span class="fw-bold"> RA 111261 </span> or the <span
                                            class="bold">First Time Jobseeker Act of 2019.</span>
                                        <br>
                                        <p class="mt-4 fs-3 lh-base">
                                            I further certify that the holder/bearer was informed of his/her rights,
                                            including the duties and responsibilities accorded
                                            by RA 11261 through the Oath of Undertaking he has signed and executed in the
                                ...
                                <p class="mt-4 fs-3 lh-base">
                                    @switch($request->certificate_type)
                                        @case('Barangay Clearance')
                                            <span class="fw-bold">THIS IS TO CERTIFY FURTHER</span>
                                            that he/she has no pending case in this barangay and is a person of good
                                            moral character known to have a good reputation in the community.
                                        @break

                                        @case('Barangay Business Permit')
                                            <span class="fw-bold">THIS IS TO CERTIFY FURTHER</span>
                                            that he/she is a Law Abiding Citizen.
                                        @break
                                ...
                                <p class="mt-4 mb-5 fs-3 lh-base">
                                ...
                                <div class="pb-4 mt-5 text-end fs-3">
                                    <h4 class="mt-4 mb-0 text-uppercase">
                                        <strong
                                            class="text-decoration-underline fs-3">{{ $capt->first_name . ' ' . $capt->middle_name . ' ' . $capt->last_name }}</strong>
                                    </h4>
                ...
                @default
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-5 mb-5">
                            <p class="fs-3 fw-bold text-start">TO WHOM IT MAY CONCERN:</p>

                            <p class="mt-4 text-start fs-3 lh-base">
                            ...
                            <p class="mt-4 text-start fs-3 lh-base">
                                ...
                                @elseif($request->certificate_type == 'Certificate of Community Service')
                                    ...
                                    {{ ucfirst($setting->barangay_name . ', ' . $setting->municipal_name . ', ' . $setting->province_name) }}.
                                @elseif($request->certificate_type == 'Barangay Business Permit')
                            ...
                            <p class="mt-4 text-start fs-3 lh-base">
                                <span class="fw-bold">ISSUED</span> this
                                <span class="fw-bold">{{ \Carbon\Carbon::parse($request->updated_at)->format('jS') }}</span>
                                day of
                                <span class="fw-bold">{{ \Carbon\Carbon::parse($request->updated_at)->format('F, Y') }}</span>
                                at
                                {{ ucfirst($setting->barangay_name . ', ' . $setting->municipal_name . ', ' . $setting->province_name) }},
                                Philippines.
                            </p>
